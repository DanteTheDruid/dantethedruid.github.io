...
- **Spike Balls** automatically despawn after 60 seconds due to being unkillable
...
- **Bosses** are not included in the spawn tiers and must be spawned via their own command
